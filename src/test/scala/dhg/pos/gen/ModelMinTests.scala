...
class ModelMinTests {
  ...
  @Test
  def test_ModelMinTagger {

    val modelMinTagger = new ModelMinTagger[String]()
  ...
  @Test
  def test_ModelMinTagger_completeTagging {
    ???
  }

  @Test
  def test_ModelMinTagger_coverRecurse {
    ???
  }

  @Test
  def test_ModelMinTagger_cover {
    ???
  }

  @Test
  def test_ModelMinTagger_fillRecurse {
    ???
  }

  @Test
  def test_ModelMinTagger_fill {
    ???
  }

  @Test
  def test_ModelMinTagger_tag {
  ...
  @Test
  def test_ModelMinTagger_edgeCoverWeights {
    val sentence = Vector(
      ("<S>", Map("<S>" -> 1.0)),
      ("the", Map("D" -> 1.0)),
      ("man", Map("N" -> 0.7, "V" -> 0.2, "D" -> 0.1)),
  ...
  @Test
  def test_ModelMinTagger_holeFillWeights {
    val sentence = Vector(
      ("<S>", Map("<S>" -> 1.0)),
      ("the", Map("D" -> 1.0)),
      ("man", Map("N" -> 0.7, "V" -> 0.2, "D" -> 0.1)),
